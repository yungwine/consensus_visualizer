    ...
    def _setup_layout(self) -> None:
        ...
        self._app.layout = html.Div(
            [
                        ...
                        html.Label(
                            [
                                ...
                                dcc.Dropdown(
                                    id="group",
                                    options=[
                                        {"label": g, "value": g} for g in valgroups
                                    ],
                                    value=valgroups[0],
                                    clearable=False,
                        ...
                        html.Label(
                            [
                                dcc.Checklist(
                                    id="show-empty",
                                    options=[
                                        {"label": " show empty slots", "value": "yes"}
                                    ],
                                    value=["yes"],
                ...
                dcc.Store(id="selected", data={"valgroup_id": valgroups[0], "slot": 0}),
                dcc.Graph(
                    id="summary", config={"scrollZoom": True, "displaylogo": False}
                ),
                html.Hr(),
                html.Div(
                    [
                ...
                dcc.Graph(
                    id="detail", config={"scrollZoom": True, "displaylogo": False}
                ),
